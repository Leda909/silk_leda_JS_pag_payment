...
('Skirt with bird', 'Picture', 'Sewn silk product', NULL, '', '', 'skirt.jpg', 1),
('Peace mandala', 'Mandala', 'Wall picture', NULL, '', '', 'peace.jpg', 1),
('Tit', 'Picture', 'Window picture','35','A little flying tit above glazed-pink flowers.','15 x 15', 'tit02.jpg', 0),
('Birds in the night', 'Picture', 'Wall picture',NULL, '', '', 'birdatnight.jpg', 1),
('Bird & Butterfly laptop bag', 'Picture', 'Sewn silk product', NULL, '', '','laptopbag.jpg', 1),
('Sunny mandala', 'Mandala', 'Wall picture', NULL, '', '', 'mandala07.jpg', 1),
('Svadhisthana feeling', 'Mandala', 'Window picture', NULL, '', '', 'mandala04.jpg', 1),
('Kolibri', 'Picture', 'Window picture','35','Hummingbird is gnawing nectar in the bright sun.','15 x 15', 'kolibri.jpg', 0),
('Butterflies', 'Picture', 'Wall picture', NULL, '', '', 'butterfly.jpg', 1),
...
('Jellyfish in the subconscious', 'Picture', 'Wall picture', NULL, '', '', 'jellyfish.jpg', 1),
...
('Pisces', 'Picture', 'Wall picture', NULL, '', '', 'fish02.jpg', 1),
('Spreading love', 'Mandala', 'Window picture', NULL, '', '', 'mandala13.jpg', 1),
...
('Greedy cat', 'Picture', 'Wall picture', NULL, '', '', 'greedycat.jpg', 1),
('Balerina', 'Picture', 'Wall picture', NULL, '', '', 'balerina.jpg', 1),
('Stability', 'Mandala', 'Window picture', NULL, '', '', 'mandala03.jpg', 1),
...
('Hide and seek', 'Picture', 'Wall picture', NULL, '', '', 'hideandseek.jpg', 1),
('Stable love', 'Mandala', 'Window picture', NULL, '', '', 'mandala08.jpg', 1),
('Parrots', 'Picture', 'Wall picture', NULL, '', '', 'parrot.jpg', 1),
('Owl Light', 'Picture', 'Wall picture', NULL, '', '', 'owl_lamp.jpg', 1),
('Sea life', 'Picture', 'Wall picture', NULL, '', '', 'sealife.jpg', 1),
('Turtle & jellyfishes', 'Picture', 'Wall picture', NULL, '', '', 'turtle_jellyfishes.jpg', 1),
('Flower mandala', 'Mandala', 'Window picture', NULL, '', '', 'mandala11.jpg', 1),
('Rainbow sea', 'Picture', 'Wall picture', NULL, '', '', 'rainbowsea.jpg', 1),
('Turtles bag', 'Picture', 'Sewn silk product', NULL, '', '', 'turtle_bag.jpg', 1),
('Poppy', 'Picture', 'Wall picture', NULL, '', '', 'poppy.jpg', 1),
('Purple butterfly', 'Picture', 'Wall picture', NULL, '', '', 'butterfly02.jpg', 1),
('Butterfly and yellow cubes', 'Picture', 'Sewn silk product', NULL, '', '', 'pillow03.jpg', 1),
('Self-esteem', 'Mandala', 'Window picture', NULL, '', '', 'mandala10.jpg', 1),
('Dog and cat', 'Picture', 'Wall picture', NULL, '', '', 'dogcat.jpg', 1),
('Flower', 'Picture', 'Wall picture', NULL, '', '', 'flower.jpg', 1),
('Sugar flies', 'Picture', 'Wall picture', NULL, '', '', 'sugarfly.jpg', 1),
('Tree in the sky', 'Picture', 'Wall picture', NULL, '', '', 'tree01.jpg', 1),
('Chakras', 'Picture', 'Wall picture', NULL, '', '', 'chakras.jpg', 1),
('Matyik', 'Picture', 'Wall picture', NULL, '', '', 'matyik.jpg', 1),
('Universal love', 'Picture', 'Wall picture', NULL, '', '', 'universallove.jpg', 1),
('Heads', 'Picture', 'Wall picture', NULL, '', '', 'heads.jpg', 1),
...
CREATE TABLE IF NOT EXISTS `payments` (
    ...
    `total_price_currency` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'usd',
